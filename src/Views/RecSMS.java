 ...
 * @author lrami
 */
public class RecSMS extends javax.swing.JFrame {
    ...
    if (codigoIngresado.isEmpty()) {
        JOptionPane.showMessageDialog(null, "El campo de codigo no debe estar vacío.", "Campo Vacío", JOptionPane.WARNING_MESSAGE);
        return;
    }
    if (codigoAleatorio.equals(codigoIngresado)) {
        RestCorreo recuperacion = new RestCorreo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecSMS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

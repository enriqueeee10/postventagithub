...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            ...
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notification/error.png")));
    ...
    private void initComponents() {
        ...
        lbMessageText.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lbMessageText.setForeground(new java.awt.Color(51, 51, 51));
